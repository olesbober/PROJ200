...
public:
	...
	// getter function for hoursRemaining
	int getHoursRemaining() { return hoursRemaining; }

	// setter function for hours remaining
	void setHoursRemaining(int hR) { hoursRemaining = hR; }
...
// returns number of hours remaining in spot
